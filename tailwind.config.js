	...
	theme: {
		extend: {
			...
			flex: {
				...
				"1-0-main-padding": "1 0 var(--main-padding)",
				"0-1-main-padding": "0 1 var(--main-padding)",
				"0-0-main-padding": "0 0 var(--main-padding)",
				"1-1-main-padding": "1 1 var(--main-padding)",
				"0-0-main": "0 0 var(--main-width)",
				"1-0-main": "1 0 var(--main-width)",
				"0-1-main": "0 1 var(--main-width)",
				"1-1-main": "1 1 var(--main-width)",
				"2-0-main": "2 0 var(--main-width)",
				"2-1-main": "2 1 var(--main-width)",
				"0-2-main": "0 2 var(--main-width)",
				"1-2-main": "1 2 var(--main-width)",
				"2-2-main": "2 2 var(--main-width)",
				2: "2 1 0",
				"1-1.25-main": "1 1.25 var(--main-width)",
			},
		},
	},
	plugins: [],
